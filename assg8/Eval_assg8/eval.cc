...
int main()
{
	...
	csma.EnableAsciiAll(ascii.CreateFileStream("assgn.tr"));
	csma.EnablePcapAll("assgn", false);
	...
	// Server
	OnOffHelper serverHelper("ns3::UdpSocketFactory", InetSocketAddress(csmaInterfaces.GetAddress(4), PORT));
	...
	serverApps.Add(serverHelper.Install(csmaNodes.Get(2)));

	// Client
	PacketSinkHelper sinkCBR("ns3::UdpSocketFactory",
							 InetSocketAddress(Ipv4Address::GetAny(), PORT));
	ApplicationContainer sinkAppsCBR = sinkCBR.Install(csmaNodes.Get(4));
